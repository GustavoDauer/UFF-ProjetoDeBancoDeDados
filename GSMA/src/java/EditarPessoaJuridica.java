 ...
 * @author gustavo
 */
@WebServlet(urlPatterns = {"/EditarPessoaJuridica"})
public class EditarPessoaJuridica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Servlet EditarPessoaJuridica</title>");
        out.println("</head>");
        out.println("<body>");
        ...
        try {
            ...
            query = "UPDATE PessoaJuridica "
                    + "SET razao='"+nome+"', endereco='"+endereco+"', telefone='"+telefone+"', email='"+email+"', cnpj='"+cpf_cnpj+"' "
